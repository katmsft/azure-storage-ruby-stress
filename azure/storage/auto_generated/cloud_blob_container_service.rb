    ...
    module AutoGenerated
      module CloudBlobContainerService
        ...
        class Exists_args
          ...
          FIELDS = {
            REQINFO => { type: ::Thrift::Types::STRUCT, name: "reqInfo", class: ::Azure::Storage::AutoGenerated::ContainerRequestInfo },
        ...
        class Exists_result
          ...
          FIELDS = {
            SUCCESS => { type: ::Thrift::Types::STRUCT, name: "success", class: ::Azure::Storage::AutoGenerated::BlobContainerExistsResponse },
        ...
        class FetchAttributes_result
          ...
          FIELDS = {
            SUCCESS => { type: ::Thrift::Types::STRUCT, name: "success", class: ::Azure::Storage::AutoGenerated::BlobContainerResponse },
        ...
        class CreateContainer_args
          ...
          FIELDS = {
            REQINFO => { type: ::Thrift::Types::STRUCT, name: "reqInfo", class: ::Azure::Storage::AutoGenerated::ContainerRequestInfo },
            ACCOUNTINFO => { type: ::Thrift::Types::STRUCT, name: "accountInfo", class: ::Azure::Storage::AutoGenerated::StorageAccountInfo },
            ACCESSTYPE => { type: ::Thrift::Types::I32, name: "accessType", enum_class: ::Azure::Storage::AutoGenerated::BlobContainerPublicAccessType },
          ...
          def validate
            unless @accessType.nil? || ::Azure::Storage::AutoGenerated::BlobContainerPublicAccessType::VALID_VALUES.include?(@accessType)
        ...
        class CreateContainer_result
          ...
          FIELDS = {
            SUCCESS => { type: ::Thrift::Types::STRUCT, name: "success", class: ::Azure::Storage::AutoGenerated::CreateContainerResponse },
            STORAGEEXCEPTION => { type: ::Thrift::Types::STRUCT, name: "storageException", class: ::Azure::Storage::AutoGenerated::WrappedStorageException }
          }
        ...
        class ListBlobsSegmented_args
          ...
          FIELDS = {
            ...
            CONTINUATIONTOKEN => { type: ::Thrift::Types::STRUCT, name: "continuationToken", class: ::Azure::Storage::AutoGenerated::ThriftBlobContinuationToken },
            CONTAINERNAME => { type: ::Thrift::Types::STRING, name: "containerName" }
          }
        ...
        class AcquireLease_result
          ...
          FIELDS = {
            SUCCESS => { type: ::Thrift::Types::STRUCT, name: "success", class: ::Azure::Storage::AutoGenerated::ContainerChangeAcquireLeaseResponse },
            STORAGEEXCEPTION => { type: ::Thrift::Types::STRUCT, name: "storageException", class: ::Azure::Storage::AutoGenerated::WrappedStorageException }
          }
        ...
        class BreakLease_result
          ...
          FIELDS = {
            SUCCESS => { type: ::Thrift::Types::STRUCT, name: "success", class: ::Azure::Storage::AutoGenerated::ContainerBreakLeaseResponse },
            STORAGEEXCEPTION => { type: ::Thrift::Types::STRUCT, name: "storageException", class: ::Azure::Storage::AutoGenerated::WrappedStorageException }
          }
        ...
        class GetPermissions_result
          ...
          FIELDS = {
            SUCCESS => { type: ::Thrift::Types::STRUCT, name: "success", class: ::Azure::Storage::AutoGenerated::ContainerGetPermissionsResponse },
            STORAGEEXCEPTION => { type: ::Thrift::Types::STRUCT, name: "storageException", class: ::Azure::Storage::AutoGenerated::WrappedStorageException }
          }

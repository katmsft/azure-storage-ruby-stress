    ...
    module Handler
      class CloudQueueClientHandler < BaseHandler
        ...
        def getProperties(thriftRequestOptions, thriftOperationContext, accountInfo)
          ...
          # ==== Construct Reture Value ==== #
          result = Azure::Storage::Converter::CoreConverter.convertServicePropertiesToThriftStorageServiceProperties(temp)
          return result
        end
        def getServiceStats(thriftRequestOptions, thriftOperationContext, accountInfo)
          ...
          # ==== Construct Reture Value ==== #
          result = Azure::Storage::Converter::CoreConverter.convertGetServiceStatsResultToThriftServiceStats(temp)
          return result
        end
      end
    end

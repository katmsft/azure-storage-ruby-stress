    ...
    class TableConverter
      ...
      def self.getStorageEntityFromThriftOperation(thriftOperation)
        unless thriftOperation.nil?
          options = self.getStorageEntityWithoutPKRKFromThriftOperation(thriftOperation)
      ...
      def self.getStorageEntityWithoutPKRKFromThriftOperation(thriftOperation)
        options = {}
        unless thriftOperation.nil?
          thriftOperation.entity.properties.each do |key, property|
            ...
            options[key] = true if type == "Edm.Boolean" && !property.isNull && property.value == "1" # Special handling for thrift true to be "1".
            options[key + "@odata.type"] = type
      ...
      def self.getThriftEntityFromStorageEntity(storageEntity)
        ...
        storageEntity.properties.each do |key, value|
          if key.to_s == "PartitionKey"
            ...
            entity.rowKey = value
          elsif key.to_s == "Timestamp"
            entity.timestamp = XSS::Utilities::timeStringToInteger(value)
          else
            ...
            property.value =
              ...
              when XSS::AutoGenerated::ThriftEdmType::Boolean
                value ? "1" : "0"
              else
                value.to_s
      ...
      def self.getStorageBatchFromThriftOperations(tableName, thriftOperations, reqOptions)
        ...
        thriftOperations.each do |operation|
          ...
          entity = getStorageEntityWithoutPKRKFromThriftOperation(operation)
          ...
          when XSS::AutoGenerated::ThriftTableOperationType::Retrieve
            batch.get(operation.entity.rowKey)
          end
        end
        batch
      end

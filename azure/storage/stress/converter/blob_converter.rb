  ...
  module Converter
    class BlobConverter
      ...
      def self.buildListBlobItemWithBlobContainerAndClient(blob, container, client)
        ...
        item.uri = XSS::Converter::CoreConverter::getCloudStorageUriWithClientAndPath(client, URI.encode(blobPath))
        item.parentContainerUri = XSS::Converter::CoreConverter::getCloudStorageUriWithClientAndPath(client, URI.encode(container))

  ...
  module Converter
    class BlobConverter
      ...
      def self.updateCloudBlobResponseFromInternalRequestInfo(response, rInfo)
        ...
        response.blobType = XSS::Utilities::thriftizeString(XSS::AutoGenerated::BlobType, rInfo.responseHeaders["x-ms-blob-type"], response.blobType || 0) if rInfo.responseHeaders["x-ms-blob-type"]

  ...
  module Converter
    class CoreConverter
      def self.getStorageService(handler, accountInfo)
        ...
        options[:stroage_file_host] = accountInfo.fileUri.primaryUri if accountInfo.fileUri
        ...
        # Create Client
        client = Azure::Storage::Client.create(options)
      end
      ...
      def self.getRequestOptions(thriftRequestOptions)
        ...
        unless thriftRequestOptions.nil?
          ...
          options[:location_mode] = thriftRequestOptions.LocationMode

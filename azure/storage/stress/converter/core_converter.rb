  ...
  module Converter
    class CoreConverter
      ...
      def self.convertThriftStorageServicePropertiesToServiceProperties(properties)
        storageProperties = Azure::Storage::Common::Service::StorageServiceProperties.new
      ...
      def self.convertCorsRuleArrayToCORSArray(corsRules)
        corss = Azure::Storage::Common::Service::Cors.new
        return corss if corsRules.nil?
        corsRules.each do |corsRule|
          cors = Azure::Storage::Common::Service::CorsRule.new
      ...
      def self.getSignedIdentifiersFromThriftSharedAccessPolicies(sharedAccessPolicies)
        ...
        sharedAccessPolicies.each { |id, sharedAccessPolicy|
          signedIdentifier = Azure::Storage::Common::Service::SignedIdentifier.new
          accessPolicy = Azure::Storage::Common::Service::AccessPolicy.new

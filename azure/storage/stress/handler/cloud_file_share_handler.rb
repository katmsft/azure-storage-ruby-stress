  ...
  module Handler
    class CloudFileShareHandler < CloudFileBaseHandler
      def createShare(accountInfo, shareName, createIfNotExists, snapshotTime, fileRequestOptions, operationContext)
        ...
        if createIfNotExists
          ...
          if (exists.exists)
            ...
            r.wasCreated = false
            r.cloudFileShareResponse = exists.response
            return r
          end
        end
        # ==== Build Client ==== #
      ...
      def exists(accountInfo, shareName, snapshotTime, fileRequestOptions, operationContext)
        ...
        r.exists = exists
        r.response = XSS::Converter::FileConverter::buildCloudFileShareResponseFromInternalRequestInfo(internalRequestInfo) if exists
      ...
      def setProperties(requestInfo, accountInfo, properties)
        ...
        options.merge! XSS::Converter::CoreConverter::getOperationContextOptions(requestInfo.operationContext)
        # TODO: No supporting option in the SDK! Maybe this should be deleted?
        ...
        result = fileClient.set_share_properties(containerName, blobName, properties, options)
        # ==== Construct Return Value ==== #
      ...
      def setPermissions(reqInfo, accountInfo, permissions)
        ...
        options.merge! XSS::Converter::CoreConverter::getOperationContextOptions(reqInfo.operationContext)
        # TODO: No supporting option in the SDK! Maybe this should be deleted?

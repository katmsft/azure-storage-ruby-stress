  ...
  module Handler
    class CloudBlobHandler < CloudBlobBaseHandler
      ...
      def exists(requestInfo, accountInfo)
        ...
        result.response = XSS::Converter::BlobConverter::buildCloudBlobResponseFromInternalRequestInfo(@request_info) if exists
        result
      end
      ...
      def setProperties(requestInfo, accountInfo, properties)
        ...
        r = properties.clone
        XSS::Converter::BlobConverter::updateCloudBlobResponseFromInternalRequestInfo(r, @request_info)
        r
      end
      ...
      def downloadToStream(requestInfo, accountInfo)
        ...
        r.bytesRead = @request_info.contentLength
        r.target = body

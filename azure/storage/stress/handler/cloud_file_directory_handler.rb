    ...
    class CloudFileDirectoryHandler < CloudFileBaseHandler
      def createDirectory(accountInfo, filePath, createIfNotExists, fileRequestOptions, operationContext)
        ...
        if createIfNotExists
          ...
          if (exists.exists)
            return exists.cloudFileDirectoryResponse
          end
        end
        # ==== Build Client ==== #
        ...
        r.cloudFileDirectoryResponse = XSS::Converter::FileConverter::bulidCloudFileDirectoryResponseFromInternalRequestInfo(internalRequestInfo)
      ...
      def exists(accountInfo, filePath, fileRequestOptions, operationContext)
        ...
        result.cloudFileDirectoryResponse = XSS::Converter::FileConverter::bulidCloudFileDirectoryResponseFromInternalRequestInfo(internalRequestInfo) if exists

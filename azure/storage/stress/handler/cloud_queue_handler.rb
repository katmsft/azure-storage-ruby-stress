  ...
  module Handler
    class CloudQueueHandler < CloudQueueBaseHandler
      def create(requestInfo, accountInfo, createIfNotExists, metadata)
        ...
        r.response = XSS::Converter::QueueConverter::buildCloudQueueResponseFromInternalRequestInfo(internalRequestInfo, queueName)
        r
      end
      ...
      def exists(requestInfo, accountInfo)
        ...
        result.response = XSS::Converter::QueueConverter::buildCloudQueueResponseFromInternalRequestInfo(internalRequestInfo, queueName)
        result
      end
      ...
      def fetchAttributes(requestInfo, accountInfo)
        ...
        result = XSS::Converter::QueueConverter::buildCloudQueueResponseFromInternalRequestInfo(internalRequestInfo, queueName)

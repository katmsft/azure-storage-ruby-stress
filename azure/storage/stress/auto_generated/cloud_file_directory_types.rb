  ...
  module AutoGenerated
    ...
    class CreateFileDirectoryResponse
      ...
      FIELDS = {
        ...
        CLOUDFILEDIRECTORYRESPONSE => { type: ::Thrift::Types::STRUCT, name: "cloudFileDirectoryResponse", class: ::XSS::AutoGenerated::CloudFileDirectoryResponse }
      }
    ...
    class ExistsFileDirectoryResponse
      ...
      FIELDS = {
        ...
        CLOUDFILEDIRECTORYRESPONSE => { type: ::Thrift::Types::STRUCT, name: "cloudFileDirectoryResponse", class: ::XSS::AutoGenerated::CloudFileDirectoryResponse, optional: true }
      }
    ...
    class CloudFileListItem
      ...
      FIELDS = {
        ...
        ATTRIBUTES => { type: ::Thrift::Types::STRUCT, name: "attributes", class: ::XSS::AutoGenerated::CloudFileResponse }
      }
    ...
    class CloudFileDirectoryListItem
      ...
      FIELDS = {
        NAME => { type: ::Thrift::Types::STRING, name: "name" },
        URI => { type: ::Thrift::Types::STRUCT, name: "uri", class: ::XSS::AutoGenerated::CloudStorageUri },
        PROPERTIES => { type: ::Thrift::Types::STRUCT, name: "properties", class: ::XSS::AutoGenerated::CloudFileDirectoryResponse }
      }
    ...
    class ListFileDirResponse
      ...
      FIELDS = {
        CONTINUATIONTOKEN => { type: ::Thrift::Types::STRUCT, name: "continuationToken", class: ::XSS::AutoGenerated::ThriftFileContinuationToken, optional: true },
        DIRECTORIES => { type: ::Thrift::Types::LIST, name: "directories", element: { type: ::Thrift::Types::STRUCT, class: ::XSS::AutoGenerated::CloudFileDirectoryListItem }, optional: true },
        FILES => { type: ::Thrift::Types::LIST, name: "files", element: { type: ::Thrift::Types::STRUCT, class: ::XSS::AutoGenerated::CloudFileListItem }, optional: true }
      }
